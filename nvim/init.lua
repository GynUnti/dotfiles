...
-- ============================================================================
-- ORIGINAL: radleylewis/nvim-lite
-- I made some minimal changes to fit my preference
-- Check out radleylewis original repo
-- ============================================================================
...
vim.opt.matchtime = 1 -- delay time for matching brackets
...
vim.opt.guicursor =
	"n-v-c:block,i-ci-ve:ver50,r-cr:hor20,o:hor50,a:blinkwait700-blinkoff400-blinkon250-Cursor/lCursor,sm:block-blinkwait175-blinkoff150-blinkon175" -- cursor blinking and settings
...
local function get_notes_path()
	...
	if os_release:match("EndeavourOS") then
		return vim.fn.expand("~/Documents/obsidian_note")
...
local function setup_obsidian()
	require("obsidian").setup({
		...
		workspaces = { { name = "obsidian_note", path = get_notes_path() } },
		picker = { name = "fzf-lua" },
	})
